...
test('namespace', function (t) {
  ...
  t.alike(ns[0].ns, b4a.from('a931a0155b5c09e6d28628236af83c4b8a6af9af60986edeede9dc5d63192bf7', 'hex'))
  t.alike(ns[1].ns, b4a.from('742c9d833d430af4c48a8705e91631eecf295442bbca18996e597097723b1061', 'hex'))
})

test('namespace (random access)', function (t) {
  const ns = crypto.namespace('hyperswarm/secret-stream', [1, 0])

  t.alike(ns[0].ns, b4a.from('742c9d833d430af4c48a8705e91631eecf295442bbca18996e597097723b1061', 'hex'))
  t.alike(ns[1].ns, b4a.from('a931a0155b5c09e6d28628236af83c4b8a6af9af60986edeede9dc5d63192bf7', 'hex'))
})

test('another namespace', function (t) {
  const ns = crypto.namespace('foo', [1])

  t.alike(ns[0].ns, b4a.from('fff5eac99641b1b9dee6cabaaeb5959f4b452f7c83769156566aa44de89c82fb', 'hex'))
})
